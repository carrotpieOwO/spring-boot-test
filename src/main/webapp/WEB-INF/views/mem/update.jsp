...
<body>
	...
	<table border="1">
		...
		<tr>
			<td><input id="id" type="text" value="${mem.id}"
			...
			<td><input type="text" value="${mem.createTime}" /></td>
		</tr>
	</table>
	<button id="mem_update_proc">edit</button> <button id="mem_delete">delete</button>
